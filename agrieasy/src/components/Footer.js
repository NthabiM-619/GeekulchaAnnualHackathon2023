...
const Footer = () => {
  return (
    <footer className="bg-[#e4eae1] relative bottom-0 left-0 right-0 -z-10">
            ...
            <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 sm:gap-y-10 lg:grid-cols-4">
                <div className="sm:col-span-2">
                    ...
                    <div className="flex flex-col mx-auto mt-6 space-y-3 md:space-y-0 md:flex-row">
                        <input id="email" type="text" className="px-4 py-2 text-white bg-white border rounded-md dark:border-[#779867] focus:border-green-800 dark:focus:border-green-800 focus:outline-none focus:ring focus:ring-opacity-40 focus:ring-green-800" placeholder="Email Address" />
                
                        <button className="w-full px-6 py-2.5 text-sm font-medium tracking-wider text-white transition-colors duration-300 transform md:w-auto md:mx-4 focus:outline-none bg-[#779867] rounded-lg hover:bg-[#779847] focus:ring focus:ring-gray-300 focus:ring-opacity-80">
                            Subscribe
                        </button>
                    </div>
                </div>
